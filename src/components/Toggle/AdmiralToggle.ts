...
import type { ToggleProps } from './AdmiralToggle.types.js';
 ...
 *
 * @example
 * <admiral-toggle id="toggle-1" checked></admiral-toggle>
 */
@customElement('admiral-toggle')
export class AdmiralToggle extends LitElement {
