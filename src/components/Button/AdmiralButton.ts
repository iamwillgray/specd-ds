...
import type { ButtonProps, ButtonVariant, ButtonSize, ButtonType } from './AdmiralButton.types.js';

/**
 * Admiral DS — Button
 *
 * A multi-variant button component. Renders into the light DOM so global
 * Admiral CSS (tokens + components.css) applies without Shadow DOM piercing.
 *
 * @element admiral-button
 *
 ...
 * <admiral-button variant="ghost" size="sm">Cancel</admiral-button>
 */
