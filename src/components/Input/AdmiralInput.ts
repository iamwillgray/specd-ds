...
import type { InputProps, InputType } from './AdmiralInput.types.js';
 ...
 *
 * @example
 * <admiral-input placeholder="Search…" search></admiral-input>
 */
@customElement('admiral-input')
export class AdmiralInput extends LitElement {
