...
import type { CardProps, CardElevation } from './SpecdCard.types.js';
 ...
 *
 * @example
 * <specd-card elevation="flat">
 *   <p>Hello world</p>
 * </specd-card>
 */
@customElement('specd-card')
export class SpecdCard extends LitElement {
