...
export const AllElevations: Story = {
  render: () => html`
    <div style="display:flex;flex-direction:column;gap:12px;max-width:320px;">
      <admiral-card elevation="elevated"><p style="margin:0;">Elevated</p></admiral-card>
      <admiral-card elevation="flat"><p style="margin:0;">Flat</p></admiral-card>
      <admiral-card elevation="inset"><p style="margin:0;">Inset</p></admiral-card>
    </div>
  `,
};
