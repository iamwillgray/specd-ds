...
import type { AvatarProps, AvatarSize } from './SpecdAvatar.types.js';
 ...
 */
@customElement('specd-avatar')
export class SpecdAvatar extends LitElement {
