...
import type { BadgeProps, BadgeIntent } from './SpecdBadge.types.js';
 ...
 *
 * @example
 * <specd-badge value="5" intent="negative"></specd-badge>
 */
@customElement('specd-badge')
export class SpecdBadge extends LitElement {
